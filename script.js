document.addEventListener("DOMContentLoaded", function () {
  const cartaTexto = `Hola mi amor, es una de mis primeras veces haciendo esto para alguien y tengo la verdad miedo de que me salte algún error jsjsjs.
...
PD:GRACIAS POR TODO LO QUE HACES POR MI JAMÁS CAMBIES PORFA TE AMO MUCHISIMO MI AMOR`;
  ...
  function escribir() {
    if (i < cartaTexto.length) {
      textoElemento.innerHTML += cartaTexto.charAt(i);
      i++;
